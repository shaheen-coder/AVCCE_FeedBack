...
SECRET_KEY = 'django-insecure-&90ya8v#68i%e$g7@v65no)be)5+_mwq%d1*b^_ne&n3!wf(aa'
...
WSGI_APPLICATION = 'fbrm.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "HOD", "url": "hod-dash", "new_window": False},
        {"name": "Staff", "url": "tea-dash", "new_window": False},
        {"name": "prinicipal", "url": "hoc-dash", "new_window": False},
